...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="bg-gray-50 p-4 rounded-lg mb-6">
        <form method="GET" action="{{ route('admin.marcas.index') }}" class="flex flex-wrap gap-4">
            ...
            <a href="{{ route('admin.marcas.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md transition duration-200">
        ...
        <table class="min-w-full table-auto">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Mercado</th>
                ...
                @forelse($marcas as $marca)
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $marca->name }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $marca->mercado }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
