            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" 
                           id="aluguel_carro" 
                           name="aluguel_carro" 
                           value="{{ old('aluguel_carro', $frota->aluguel_carro) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           id="rastreador" 
                           name="rastreador" 
                           value="{{ old('rastreador', $frota->rastreador) }}"
                           step="0.01"
                           min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('provisoes_avarias', $frota->provisoes_avarias) }}"
                           step="0.01"
                           min="0"
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('provisao_desmobilizacao', $frota->provisao_desmobilizacao) }}"
                           step="0.01"
                           min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('provisao_diaria_rac', $frota->provisao_diaria_rac) }}"
                           step="0.01"
                           min="0"
        ...
        <div class="bg-blue-50 p-6 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-blue-800" x-text="formatCurrency(form.fipe * form.percentual_fipe / 100)">R$ {{ number_format(($frota->fipe * $frota->percentual_fipe / 100), 2, ',', '.') }}</p>
                </div>
                <div class="text-center">
...
function frotaForm() {
    return {
        form: {
            ...
            fipe: {{ old('fipe', $frota->fipe) }},
            percentual_fipe: {{ old('percentual_fipe', $frota->percentual_fipe) }},
            aluguel_carro: {{ old('aluguel_carro', $frota->aluguel_carro) }},
            rastreador: {{ old('rastreador', $frota->rastreador) }},
            provisoes_avarias: {{ old('provisoes_avarias', $frota->provisoes_avarias) }},
            provisao_desmobilizacao: {{ old('provisao_desmobilizacao', $frota->provisao_desmobilizacao) }},
            provisao_diaria_rac: {{ old('provisao_diaria_rac', $frota->provisao_diaria_rac) }}
        },
