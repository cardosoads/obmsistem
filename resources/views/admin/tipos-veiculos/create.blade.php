...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Novo Tipo de Veículo</h1>
    ...
    <form action="{{ route('admin.tipos-veiculos.store') }}" method="POST" class="space-y-6">
        @csrf
