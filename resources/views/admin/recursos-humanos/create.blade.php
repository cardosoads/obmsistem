...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('admin.recursos-humanos.store') }}" method="POST" class="space-y-6" x-data="rhForm()">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="tipo_contratacao" 
                        ...
                        <option value="CLT" {{ old('tipo_contratacao') == 'CLT' ? 'selected' : '' }}>CLT</option>
                        <option value="PJ" {{ old('tipo_contratacao') == 'PJ' ? 'selected' : '' }}>PJ</option>
                        <option value="Terceirizado" {{ old('tipo_contratacao') == 'Terceirizado' ? 'selected' : '' }}>Terceirizado</option>
                        <option value="Temporário" {{ old('tipo_contratacao') == 'Temporário' ? 'selected' : '' }}>Temporário</option>
