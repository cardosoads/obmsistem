            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="tipo" 
                        ...
                        <option value="percentual" {{ old('tipo', $imposto->tipo) == 'percentual' ? 'selected' : '' }}>Percentual (%)</option>
                        <option value="fixo" {{ old('tipo', $imposto->tipo) == 'fixo' ? 'selected' : '' }}>Valor Fixo (R$)</option>
                    </select>
