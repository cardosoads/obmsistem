...
class OrcamentoController extends Controller
{
    ...
    /**
     * Store a draft with basic information only.
     */
    public function storeDraft(Request $request)
    {
        ...
        try {
            ...
            $validated['tipo_orcamento'] = 'prestador'; // Padrão para rascunho
            ...
            OrcamentoHistorico::create([
                ...
                'data_acao' => now(),
                'observacoes' => 'Rascunho criado com informações básicas'
            ]);
            
            DB::commit();
            
            return redirect()->route('admin.orcamentos.edit', $orcamento)
                           ->with('success', 'Rascunho criado com sucesso! Complete as informações restantes.');
                           
        } catch (\Exception $e) {
            DB::rollback();
            return back()->withInput()->withErrors(['error' => 'Erro ao criar rascunho: ' . $e->getMessage()]);
        }
    }
